...
TRANSLATIONS = {
    "en": {
        ...
        "logbook_info": "After a successful glider logbook upload, the app pages will become available.",
        ...
        # Flights page
        "flights_title": ":violet[:material/area_chart:] Flight statistics over time",
        "flights_warning": "No logbook loaded. Please upload a CSV using the 'Upload CSV' page from the sidebar before accessing the app.",
        ...
        # Aircraft page
        "aircraft_title": ":violet[:material/area_chart:] Aircraft statistics over time",
        "aircraft_warning": "Please upload a CSV using the 'Upload CSV' page before accessing this page.",
        ...
        # Role page
        "role_title": ":violet[:material/area_chart:] Role statistics over time",
        "role_warning": "Please upload a CSV using the 'Upload CSV' page before accessing this page.",
    ...
    "fr": {
        ...
        "logbook_info": "Après un téléchargement réussi du carnet de vol, les pages de l'application deviennent disponibles.",
        "upload_subtitle": "Option#1 : Télécharger les données du carnet de vol depuis un fichier CSV",
        ...
        "csv_example": "Exemple",
        "upload_button_label": "Télécharger un fichier CSV de vols de planeur (séparé par des points-virgules)",
        "csv_uploaded_success": "CSV téléchargé et analysé avec succès. Vous pouvez maintenant ouvrir les autres pages.",
        ...
        # Flights page
        "flights_title": ":violet[:material/area_chart:] Statistiques de vol au fil du temps",
        "flights_warning": "Aucun carnet de vol chargé. Veuillez télécharger un CSV en utilisant la page 'Télécharger CSV' de la barre latérale avant d'accéder à l'application.",
        "flights_empty_warning": "Le carnet de vol est vide pour la plage de dates sélectionnée.",
        "total_flights": "Le nombre total d'heures de vol est :green[{}] heures et :green[{}] minutes.\nDans :green[{}] vols.\nSur une période de :green[{}] ans, :green[{}] mois et :green[{}] jour(s).",
        ...
        # Aircraft page
        "aircraft_title": ":violet[:material/area_chart:] Statistiques des aéronefs au fil du temps",
        "aircraft_warning": "Veuillez télécharger un CSV en utilisant la page 'Télécharger CSV' avant d'accéder à cette page.",
        ...
        # Role page
        "role_title": ":violet[:material/area_chart:] Statistiques des rôles au fil du temps",
        "role_warning": "Veuillez télécharger un CSV en utilisant la page 'Télécharger CSV' avant d'accéder à cette page.",
...
def detect_browser_language() -> str:
    ...
    try:
        ...
        if hasattr(st, 'get_query_params'):
            ...
            if 'lang' in params:
                lang = params['lang'][0] if isinstance(params['lang'], list) else params['lang']
